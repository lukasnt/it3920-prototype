...
class LocalTimeIntervalTest {
  ...
  def intervalBefore(): Unit = {
    val interval1 = new LocalTimeInterval(LocalTime.of(0, 0), LocalTime.of(0, 1))
    val interval2 = new LocalTimeInterval(LocalTime.of(0, 2), LocalTime.of(0, 3))
    assertTrue(interval1.before(interval2))
  }

  @Test
  def intervalNotBefore(): Unit = {
    val interval1 = new LocalTimeInterval(LocalTime.of(0, 0), LocalTime.of(0, 2))
    val interval2 = new LocalTimeInterval(LocalTime.of(0, 2), LocalTime.of(0, 3))
  ...
  def intervalMeets(): Unit = {
    val interval1 = new LocalTimeInterval(LocalTime.of(0, 0), LocalTime.of(0, 1))
    val interval2 = new LocalTimeInterval(LocalTime.of(0, 1), LocalTime.of(0, 2))
    assertTrue(interval1.meets(interval2))
  }

  @Test
  def intervalOverlaps(): Unit = {
    val interval1 = new LocalTimeInterval(LocalTime.of(0, 0), LocalTime.of(0, 3))
    val interval2 = new LocalTimeInterval(LocalTime.of(0, 2), LocalTime.of(0, 4))
  ...
  def intervalNotOverlaps(): Unit = {
    val interval1 = new LocalTimeInterval(LocalTime.of(0, 0), LocalTime.of(0, 3))
    val interval2 = new LocalTimeInterval(LocalTime.of(0, 3), LocalTime.of(0, 4))
    assertTrue(interval1.overlaps(interval2))
  }

  @Test
  def intervalDuring(): Unit = {
    val interval1 = new LocalTimeInterval(LocalTime.of(0, 1), LocalTime.of(0, 4))
    val interval2 = new LocalTimeInterval(LocalTime.of(0, 0), LocalTime.of(0, 5))
  ...
  def intervalNotDuring(): Unit = {
    val interval1 = new LocalTimeInterval(LocalTime.of(0, 1), LocalTime.of(0, 4))
    val interval2 = new LocalTimeInterval(LocalTime.of(0, 2), LocalTime.of(0, 5))
  ...
  def intervalNotStarts(): Unit = {
    val interval1 = new LocalTimeInterval(LocalTime.of(0, 2), LocalTime.of(0, 4))
    val interval2 = new LocalTimeInterval(LocalTime.of(0, 1), LocalTime.of(0, 5))
    assertFalse(interval1.starts(interval2))
  }

  @Test
  def intervalFinishes(): Unit = {
    val interval1 = new LocalTimeInterval(LocalTime.of(0, 3), LocalTime.of(0, 5))
    val interval2 = new LocalTimeInterval(LocalTime.of(0, 0), LocalTime.of(0, 5))
  ...
  def intervalNotFinishes(): Unit = {
    val interval1 = new LocalTimeInterval(LocalTime.of(0, 2), LocalTime.of(0, 5))
    val interval2 = new LocalTimeInterval(LocalTime.of(0, 2), LocalTime.of(0, 6))
